...
# date              :20180807
# version           :1.0
# usage             :python training.py -l 1000 -i ./train_example/tr/encode -j ./train_example/val/encode -k ./train_example/test/encode -o ./train_example/models -f 10 -n 100 -d 100 -e 30
...
if os.path.isfile(modName):
  ...
  ## siamese
  forward_input = Input(shape=(contigLength, channel_num))
  reverse_input = Input(shape=(contigLength, channel_num))
  hidden_layers = [
      Conv1D(filters = nb_filter1, kernel_size = filter_len1, activation='relu'),
      L1Pooling(), # Adding our custom L2 Pooling Layer
