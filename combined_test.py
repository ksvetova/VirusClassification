...
virus_file_path = 'virus-test-sample100K.fa'
host_file_path = 'host-test-sample100K.fa'
output_virus_file_path = 'sampled_test_virus_data.fa'
output_host_file_path = 'sampled_test_host_data.fa'

# target total lengths for testing set
target_virus_length = 982114
target_host_length = 938015
