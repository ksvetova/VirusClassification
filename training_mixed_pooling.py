...
parser.add_option("-p", "--lambda", action = "store", type = float, dest = "p",
                                    default=0.5, help = "lambda parameter for mixed pooling")
...
if os.path.isfile(modName):
  ...
  hidden_layers = [
      ...
      MixedPooling(p=p), # Adding our custom Mixed Pooling Layer
